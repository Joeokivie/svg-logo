        ...
        .prompt([
            {
                ...
                validate: (text) => 
                text.length <=  3 || "The message can't be more than 3 characters",
            }, 
            {
                name: "textColor",
                type: "input",
                message: "Please enter a text color of your choosing",
            },
            {
                name: "logoShape",
                type: "list",
                message: "Select a shape for the logo that you like",
                choices: ["circle", "square", "triangle"]
            },
            {
                name: "shapeColor",
                type: "input",
                message: "Enter a shape color that fits you"
            }
        ])
        /**
